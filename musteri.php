            ...
            <form>
                ...
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <input disabled="" type="text" class="form-control" name="musteri_telefon"
                ...
                <div class="form-row">
                    <div class="col-md-6 form-group">
                        ...
                        <textarea disabled="" id="editor" name="musteri_detay"
                            class="form-control"><?php echo $musteribilgisi['musteri_detay'] ?></textarea>
                    </div>
                </div>
            </form>
        </div>
