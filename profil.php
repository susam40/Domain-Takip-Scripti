                        ...
                        <div class="form-row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="kul_isim" class="form-control"
                                    value="<?php echo $kullanici['kul_isim'] ?>" placeholder="İsminizi Girin">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mail : </label>
                                <input type="text" name="kul_mail" class="form-control"
                                    value="<?php echo $kullanici['kul_mail'] ?>" placeholder="Mail Adresinizi Girin">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                <label>Telefon : </label>
                                <input type="text" name="kul_telefon" class="form-control"
                                    value="<?php echo $kullanici['kul_telefon'] ?>" placeholder="Telefonuzu Girin">
                            </div>
                        </div>
